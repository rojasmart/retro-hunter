  ...
  return (
    <ProtectedRoute>
      <div className="min-h-screen bg-gray-900 text-white font-mono">
        {/* Navigation */}
        <nav className="bg-black/50 shadow-sm border-b border-cyan-500/30">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between items-center h-16">
              <div className="flex items-center space-x-8">
                <a href="/" className="text-xl font-bold bg-gradient-to-r from-green-400 via-pink-400 to-purple-400 bg-clip-text text-transparent">
                  RETRO HUNTER
                </a>
                <div className="flex space-x-4">
                  <a href="/my-account" className="text-cyan-300 hover:text-pink-400 transition-colors">
                    Minha Conta
                  </a>
                  <a href="/my-collection" className="text-pink-400 font-medium">
                    Minha Coleção
                  </a>
                </div>
              </div>
        ...
        <div className="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex justify-between items-center mb-8">
            <div>
              <h1 className="text-3xl font-bold text-cyan-300">Minha Coleção</h1>
              <p className="text-cyan-100/80">Gerir a sua coleção de jogos retro</p>
            </div>
            <button
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <div className="bg-black/40 backdrop-blur-sm p-6 rounded-lg border border-cyan-400/50 shadow-xl">
              ...
              <div className="text-cyan-100/80">Jogos na Coleção</div>
            </div>
            <div className="bg-black/40 backdrop-blur-sm p-6 rounded-lg border border-green-400/50 shadow-xl">
              ...
              <div className="text-cyan-100/80">Valor Total Investido</div>
            </div>
            <div className="bg-black/40 backdrop-blur-sm p-6 rounded-lg border border-purple-400/50 shadow-xl">
              ...
              <div className="text-cyan-100/80">Plataformas Diferentes</div>
            </div>
          </div>
